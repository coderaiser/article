...
О самом приложении сказано достаточно, но есть несколько вещей которые хотелось бы добавить о том, как оно разрабатывается.
...
Во-второй ветке находится стабильная версия. Та, которая лежит в [npm](https://www.npmjs.org/package/cloudcmd "Node Package Manager").
...
Если же, на каком-то из сервисов приложение не работает, [на сайте](http://cloudcmd.io "Cloud Commander), в самом верху,
возле ссылок отображаются не зеленые кружки, а красные.
