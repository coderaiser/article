...
![Cloud Commander](http://cloudcmd.io/img/screen/menu.png "Cloud Commander")
...
пользуюясь Тоталом, в нём не было. Не было их и в графических менеджерах. Одна из таких функций, это перемещение
указателя текущего файла во время ввода его имени на имя, которое подходит
...
Это веб-файловый менеджер **Cloud Commander**.
