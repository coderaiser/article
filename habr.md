...
На самом деле это очень важный процес. Изминения, исправления, рефакторинг и прочее иммеют свою приставку, а во-время
релиза коммиты с приставками feature и fix выстаскиваются из истории, и выводятся в определенном виде
в ChangeLog, всё это делается одной коммандой: `gulp changelog`.
