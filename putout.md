...
Работа `putout` строится на системе правил. Каждое правило `putout` представляет собой плагин. С помощью правил можно сделать следующее:
1. Найти и удалить:
