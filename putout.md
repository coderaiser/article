...
[Putout](https://github.com/coderaiser/putout) - это трансформатор кода с поддержкой плагинов. По сути это нечто среднее между [eslint](https://eslint.org) и [babel](https://babeljs.io), объединяющее в себе достоинства обоих инструментов.
