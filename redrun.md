...
Ага, `nodemon` мы не установили, и нам потребовалась всего 1 секунда, что бы это узнать. Хочу обратить внимания читателя, на то, что команда полностью развернулась, и `nodemon` будет перезапускать непосредственно `tape`, а не `npm test`.
