...
Есть [много библиотек](https://github.com/mysticatea/npm-run-all/issues/10), упрощающих взаимодействие с npm-скриптами. Мы рассмотрим одну главную, которая объединяет функционал всех существующих решений, и в то же время, не отходит от основной парадигмы, а именно: запуск скриптов средствами `npm`.
