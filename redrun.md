...
И последний немаловажный момент: [разработчики npm-run-all не используют свой продукт в процессе разработки](https://github.com/mysticatea/npm-run-all/blob/3d71d922bce60814acc810e9702291e07f9b90b2/package.json#L19).
