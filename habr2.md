...
разработки, приложение писалось таким образом, что бы код мог использоваться повторно. Таким образом функционал,
...
на сколько высоко, относительно текущего каталога, она будет находится.
