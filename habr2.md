...
Например то, что обработчики ошибок должны навешиватся на каждый стрим во время когда мы 
используем `pipe`. [Pipe-io](https://github.com/coderaiser/pipe-io "Pipe-io") помогает решить
эту проблему, упростим синтаксис до минимума:
